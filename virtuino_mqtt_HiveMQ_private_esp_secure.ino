...
const char *mqtt_server = "3da171e18aeb4f779b22777d607a2082.s1.eu.hivemq.cloud"; // replace with your broker url
const char *mqtt_username = "Virtuino";
const char *mqtt_password = "Virtuino1234";
...
const char *topicHum = "DHTUwU/nodemcu/v1/hum";
const char *topicTemp = "DHTUwU/nodemcu/v1/temp";
const char *topicHI = "DHTUwU/nodemcu/v1/HI";
...
void loop()
{
  ...
  if (now - lastMsg > 5000)
  {
    ...
    dtostrf(h, 4, 2, StriHum);
    dtostrf(t, 4, 2, StriTemp);
    dtostrf(hic, 4, 2, StriHI);

    publishMessage(topicHum, String(StriHum), true);
    publishMessage(topicTemp, String(StriTemp), true);
    publishMessage(topicHI, String(StriHI), true);

    // client->publish("DHTUwU/nodemcu/v1/hum", StriHum);
    // client->publish("DHTUwU/nodemcu/v1/temp", StriTemp);
    // client->publish("DHTUwU/nodemcu/v1/HI", StriHI);
